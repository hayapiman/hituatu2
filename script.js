...
const questions = [
    ...
    "パソコンのキーボードで「S」の右隣のキーに書かれているアルファベットを答えなさい。",
...
calibrationNext.onclick = () => {
    ...
    if (
        ...
        */
        ...
        questionOrder = ["「ありがとう」を英語で書きなさい。", "24 × 15 =", "アンモニアの化学式を書きなさい。", "「戦く」の読み方を書きなさい。", "日本で一番面積が狭い都道府県を書きなさい。", "思いつく都道府県名を3つ書きなさい。", "アメリカの首都を書きなさい。", "パソコンのキーボードで「S」の右隣のキーに書かれているアルファベットを答えなさい。", "硝酸の化学式を書きなさい。", "X³を微分しなさい。"];
        /*shuffleQuestions();*/
